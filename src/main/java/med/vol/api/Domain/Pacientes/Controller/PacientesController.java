package med.vol.api.Domain.Pacientes.Controller;

import jakarta.transaction.Transactional;
import jakarta.validation.Valid;
import med.vol.api.Domain.Pacientes.DTOs.DadosDeAtualizacaoPacientes;
import med.vol.api.Domain.Pacientes.DTOs.InformacoesPacientes;
import med.vol.api.Domain.Pacientes.DTOs.MapperPacientesDTO;
...
import med.vol.api.Domain.Pacientes.PacientesService.PacienteService;
...
public class PacientesController {
   ...
   private PacienteRepository pacienteRepository;
    ...
    public ResponseEntity detalharPaciente(@PathVariable Long id){
        var paciente = pacienteRepository.getReferenceById(id);
        return ResponseEntity.ok(new InformacoesPacientes(paciente));
    }
